...
public class CANLAxis1SocketFactory implements SecureSocketFactory,
	...
	public static final Logger log = LoggerFactory
		.getLogger(CANLAxis1SocketFactory.class.getName());
	...
	private boolean enableGSIHandshake = false;
	
	public CANLAxis1SocketFactory(
		@SuppressWarnings("rawtypes") Hashtable attributes) {
	...
	public static synchronized void setConfigurator(
		CANLAxis1SocketFactoryConfigurator conf) {
	...
	private void doGSIHandshake(SSLSocket socket) throws IOException{
	...
	public Socket create(String host, int port, StringBuffer otherHeaders,
		...
		if (enableGSIHandshake)
			doGSIHandshake(socket);
	...
	/**
	 * @param enforcingHostnameChecks
	 *          the enforcingHostnameChecks to set
	 */
	...
	/**
	 * @param enableGSIHandshake the enableGSIHandshake to set
	 */
	public void setEnableGSIHandshake(boolean enableGSIHandshake) {
	
		this.enableGSIHandshake = enableGSIHandshake;
	}

...
implements CANLAxis1SocketFactoryConfigurator,
	...
	public synchronized void configure(CANLAxis1SocketFactory factory) {
		...
		factory.setEnableGSIHandshake(isEnableGSIHandshake());
	}
	...
	public boolean enableGSIHandshake() {

		return enableGSIHandshake;
	}

	
	/**
	 * @return the enableGSIHandshake
	 */
	public boolean isEnableGSIHandshake() {
